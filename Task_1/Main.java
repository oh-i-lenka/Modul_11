...
public class Main {
    ...
    public static String replacer(Map<String, String> map) {
        ...
        String wholeString="";
        try {
            br = new BufferedReader(new FileReader("D:\\Documents\\Programming\\Homework++.txt"));
        ...
        try {
            ...
            bw = new BufferedWriter(new FileWriter("D:\\Documents\\Programming\\Homework++end.txt"));
            bw.flush();
