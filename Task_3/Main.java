...
public class Main {
    ...
    public static String replacer(Map<String, String> map) {
        ...
        String wholeString="";
        try {
            br = new BufferedReader(new FileReader("D:\\Documents\\Programming\\Homework3.txt"));
        ...
        try {
            ...
            FileWriter fw = new FileWriter("D:\\Documents\\Programming\\Homework3.txt", true);
